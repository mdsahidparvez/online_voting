...
<div class="container ">
            ...
            <table class="table table-striped table-bordered table-hover ">
					...
					<?php
							$query = $conn->query("SELECT * FROM candidate WHERE position = 'Ward Chairperson' and ward='3' ");
            ...
            <table class="table table-striped table-bordered table-hover ">
					...
					<?php
							$query = $conn->query("SELECT * FROM candidate WHERE position = 'Member' and ward='3' ");
						while($fetch = $query->fetch_array())
						{
                             include ('checkcondition.php');
            ...
            <table class="table table-striped table-bordered table-hover ">
					...
					<?php
							$query = $conn->query("SELECT * FROM candidate WHERE position = 'Woman Member' and ward='3' ");
						while($fetch = $query->fetch_array())
						{
                             include ('checkcondition.php');
            ...
            <table class="table table-striped table-bordered table-hover ">
					...
					<?php
							$query = $conn->query("SELECT * FROM candidate WHERE position = 'Dalit Woman Member' and ward='3' ");
						while($fetch = $query->fetch_array())
						{
                             include ('checkcondition.php');
