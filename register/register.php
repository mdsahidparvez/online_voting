							...
							<?php 
								...
								if (isset($_POST['save'])){
									...
									<?php
										...
										$conn->query("insert into votereg(id_number, password, firstname,lastname,year_level,status) VALUES('$id_number', '$password','$firstname','$lastname','$year_level','Unvoted')");
									?>
									<script>
